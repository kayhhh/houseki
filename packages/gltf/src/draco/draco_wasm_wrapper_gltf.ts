...
const $jscomp$lookupPolyfilledValue = function (h, n) {
  let k = $jscomp.propertyToPolyfillSymbol[n];
...
$jscomp.polyfillUnisolated = function (h, n, k, p) {
  ...
  n != p &&
    null != n &&
    $jscomp.defineProperty(k, h, { configurable: !0, value: n, writable: !0 });
};
...
$jscomp.polyfill(
  ...
  function (h) {
    ...
    l.prototype.createResolveAndReject_ = function () {
      ...
      var q = this,
        u = !1;
      return { reject: f(this.reject_), resolve: f(this.resolveTo_) };
    };
    ...
    l.prototype.settleSameAsThenable_ = function (f, q) {
      const u = this.createResolveAndReject_();
      try {
    ...
    l.race = function (f) {
      return new l(function (q, u) {
        for (
          let A = $jscomp.makeIterator(f), F = A.next();
          !F.done;
          F = A.next()
        )
  ...
  $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign
    ...
    : function (h, n) {
        for (let k = 1; k < arguments.length; k++) {
          const p = arguments[k];
          if (p) for (const l in p) $jscomp.owns(p, l) && (h[l] = p[l]);
        }
        return h;
      };
$jscomp.polyfill(
